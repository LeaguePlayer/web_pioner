...
Yii::import("application.extensions.ezzeelfinder.ElFinderConnectorAction");
...
class ElFinderWidget extends CWidget
{
    ...
    protected function registerScripts()
    {
        ...
        Yii::app()->clientScript->registerCssFile($this->elFinderCssUrl . "/elfinder.full.css");
        Yii::app()->clientScript->registerScriptFile($this->elFinderJsUrl . "/elfinder.full.js");
