...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'status',
			'type'=>'raw',
			'value'=>'Place::getStatusAliases($data->status)',
			'filter'=>Place::getStatusAliases()
		),
		'sort',
		array(
			'name'=>'create_time',
...
<?php if($model->hasAttribute('sort')) Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("place");', CClientScript::POS_END) ;?>