    ...
    $.fn.flip = function(settings){
        return this.each( function() {
            ...
            flipObj = {
                ...
                firstEasing: settings.firstEasing || 'easeInCubic',
                secondEasing: settings.secondEasing || 'easeOutCubic',
                onBefore: settings.onBefore || function(){},
                onEnd: settings.onEnd || function(){},
                onAnimation: settings.onAnimation || function(){}
            };
            ...
            var defaultHorizontal=function() {
                ...
                return {
                    ...
                    "first": {
                        ...
                        width: start.width + (2 * waist), // my option
...
//                        top: flipObj.top,
            ...
            dirOptions = {
                "tb": function () {
                    ...
                    d.first.top=flipObj.top+flipObj.height;
            ...
            $clone.animate(dirOption.first,flipObj.speed,flipObj.firstEasing);

            $clone.queue(function(){
                flipObj.onAnimation($clone,$this);
                $clone.dequeue();
            });
            $clone.animate(dirOption.second,flipObj.speed,flipObj.secondEasing);
